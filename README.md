<h1 align="center"><a href="https://github.com/LeacHar/halo-comment-PandaPro" target="_blank">halo-comment-PandaPro</a></h1>

> 适用于 Halo 的评论组件。

![npm](https://img.shields.io/npm/v/halo-comment-PandaPro?style=flat-square)
[![](https://data.jsdelivr.com/v1/package/npm/halo-comment-PandaPro/badge)](https://www.jsdelivr.com/package/npm/halo-comment-PandaPro)

### 使用指南

1. 进入后台 -> 系统 -> 博客设置 -> 评论设置

2. 将 `评论模块 JS` 修改为：`https://cdn.jsdelivr.net/gh/LeacHar/halo-comment-PandaPro@1.0/dist/halo-comment.min.js`
